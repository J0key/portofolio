    ...
    <div class="flex items-center justify-end ">
      <div class="bg-black flex flex-col w-80 border border-lime-600 rounded-lg px-8 py-10">
            ...
            <form class="flex flex-col space-y-8 mt-2" action="/login" method="POST">
                ...
                <input type="text" name="username" placeholder="e.g. Mikhael" class="border rounded-lg py-3 px-3 mt-4 hover:border-lime-600 bg-black border-white placeholder-white-500 text-white">

                <label class="font-bold text-lg text-white" for="password" >Password</label> 
                <input type="password" name="password" placeholder="******" class="border rounded-lg py-3 px-3 mt-4 hover:border-lime-600 bg-black border-white placeholder-white-500 text-white">
                
                    <button name="submit" type="submit" class="border border-white hover:border-lime-600 bg-black text-white rounded-lg py-3 font-semibold">Login</button>
            </form>
        </div>
    </div>
</div> 

                    ...
                    <div class="lg:text-left text-center">
                        <div class="flex items-center justify-end ">
                            <div class="bg-black flex flex-col w-80 border border-lime-600 rounded-lg px-8 py-10">
                                ...
                                <form class="flex flex-col space-y-8" action="" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <label for="title" class="font-bold text-white text-center text-2xl">Edit Data</label>
                                    ...
                                    <button name="submit" type="submit"
                                        class="border border-white bg-black text-white hover:border-lime-600 rounded-lg py-3 font-semibold">Edit Photo</button>
                                </form>
                            </div>
                        </div>
                    </div>

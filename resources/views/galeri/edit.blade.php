...
@section('navbar')
<a href="/galeri" class="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-lime-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-lime-300 ring-offset-indigo-200 hover:ring-offset-lime-500 ease focus:outline-none">
...
<div class="bg-lime-600 h-screen sm:px-8 md:px-16 sm:py-8">
    <main class="container mx-auto max-w-screen-sm h-100">
      <!-- file upload modal -->
      <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
        ...
        <footer class="flex justify-end px-8 pb-8 pt-4">
            {{-- <a href="/galeri"> --}}
          <button id="submit" class="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none" type="submit">
            Upload now
          </button>
        {{-- </a> --}}
